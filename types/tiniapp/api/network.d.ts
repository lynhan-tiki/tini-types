...
declare namespace my {
  interface IHttpRequestSuccessResult<T> {
    readonly data: T
    readonly status?: 1 | 2 | 11 | 12 | 13 | 14 | 15 | 19 | 20 | 23
    readonly headers?: Readonly<Record<string, string>>
  }

  interface IRequestTask<T> extends Promise<IHttpRequestSuccessResult<T>> {
    abort: () => void
  }

  interface IHttpRequestOptions<T> {
    /**
     ...
     */
    success?(res: IHttpRequestSuccessResult<T>): void
   ...
   */
  function request<T = string>(options: IHttpRequestOptions<T>): IRequestTask<T>
